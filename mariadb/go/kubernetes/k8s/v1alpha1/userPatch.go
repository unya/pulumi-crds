...
func NewUserPatch(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:k8s.mariadb.com/v1alpha1:UserPatch", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetUserPatch(ctx *pulumi.Context,
	...
	var resource UserPatch
	err := ctx.ReadResource("kubernetes:k8s.mariadb.com/v1alpha1:UserPatch", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
