...
func NewUser(ctx *pulumi.Context,
	...
	var resource User
	err := ctx.RegisterResource("kubernetes:k8s.mariadb.com/v1alpha1:User", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetUser(ctx *pulumi.Context,
	...
	var resource User
	err := ctx.ReadResource("kubernetes:k8s.mariadb.com/v1alpha1:User", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
