...
func NewUserList(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:rabbitmq.com/v1beta1:UserList", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetUserList(ctx *pulumi.Context,
	...
	var resource UserList
	err := ctx.ReadResource("kubernetes:rabbitmq.com/v1beta1:UserList", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
