...
type BindingPatch struct {
	...
	Spec     BindingSpecPatchPtrOutput       `pulumi:"spec"`
	Status   BindingStatusPatchPtrOutput     `pulumi:"status"`
}
...
func NewBindingPatch(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:rabbitmq.com/v1beta1:BindingPatch", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBindingPatch(ctx *pulumi.Context,
	...
	var resource BindingPatch
	err := ctx.ReadResource("kubernetes:rabbitmq.com/v1beta1:BindingPatch", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type bindingPatchArgs struct {
	...
	Spec     *BindingSpecPatch       `pulumi:"spec"`
}
...
func (o BindingPatchOutput) Spec() BindingSpecPatchPtrOutput {
	return o.ApplyT(func(v *BindingPatch) BindingSpecPatchPtrOutput { return v.Spec }).(BindingSpecPatchPtrOutput)
}

func (o BindingPatchOutput) Status() BindingStatusPatchPtrOutput {
	return o.ApplyT(func(v *BindingPatch) BindingStatusPatchPtrOutput { return v.Status }).(BindingStatusPatchPtrOutput)
}
