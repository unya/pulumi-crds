...
func NewDatabasePatch(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:postgresql.cnpg.io/v1:DatabasePatch", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDatabasePatch(ctx *pulumi.Context,
	...
	var resource DatabasePatch
	err := ctx.ReadResource("kubernetes:postgresql.cnpg.io/v1:DatabasePatch", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
