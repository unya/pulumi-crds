...
func NewDatabaseList(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:postgresql.cnpg.io/v1:DatabaseList", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDatabaseList(ctx *pulumi.Context,
	...
	var resource DatabaseList
	err := ctx.ReadResource("kubernetes:postgresql.cnpg.io/v1:DatabaseList", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
