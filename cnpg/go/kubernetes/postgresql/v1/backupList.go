...
func NewBackupList(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:postgresql.cnpg.io/v1:BackupList", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBackupList(ctx *pulumi.Context,
	...
	var resource BackupList
	err := ctx.ReadResource("kubernetes:postgresql.cnpg.io/v1:BackupList", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
