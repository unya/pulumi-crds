...
func NewBackupPatch(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:postgresql.cnpg.io/v1:BackupPatch", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBackupPatch(ctx *pulumi.Context,
	...
	var resource BackupPatch
	err := ctx.ReadResource("kubernetes:postgresql.cnpg.io/v1:BackupPatch", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
