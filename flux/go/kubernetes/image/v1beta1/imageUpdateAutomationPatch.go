...
func NewImageUpdateAutomationPatch(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("kubernetes:image.toolkit.fluxcd.io/v1beta2:ImageUpdateAutomationPatch"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource ImageUpdateAutomationPatch
	err := ctx.RegisterResource("kubernetes:image.toolkit.fluxcd.io/v1beta1:ImageUpdateAutomationPatch", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetImageUpdateAutomationPatch(ctx *pulumi.Context,
	...
	var resource ImageUpdateAutomationPatch
	err := ctx.ReadResource("kubernetes:image.toolkit.fluxcd.io/v1beta1:ImageUpdateAutomationPatch", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
