...
func NewImageRepository(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("kubernetes:image.toolkit.fluxcd.io/v1beta2:ImageRepository"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource ImageRepository
	err := ctx.RegisterResource("kubernetes:image.toolkit.fluxcd.io/v1beta1:ImageRepository", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetImageRepository(ctx *pulumi.Context,
	...
	var resource ImageRepository
	err := ctx.ReadResource("kubernetes:image.toolkit.fluxcd.io/v1beta1:ImageRepository", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
