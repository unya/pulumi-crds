...
func NewImagePolicyPatch(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("kubernetes:image.toolkit.fluxcd.io/v1beta1:ImagePolicyPatch"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource ImagePolicyPatch
	err := ctx.RegisterResource("kubernetes:image.toolkit.fluxcd.io/v1beta2:ImagePolicyPatch", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetImagePolicyPatch(ctx *pulumi.Context,
	...
	var resource ImagePolicyPatch
	err := ctx.ReadResource("kubernetes:image.toolkit.fluxcd.io/v1beta2:ImagePolicyPatch", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
