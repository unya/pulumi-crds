...
func NewImageUpdateAutomationList(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:image.toolkit.fluxcd.io/v1beta2:ImageUpdateAutomationList", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetImageUpdateAutomationList(ctx *pulumi.Context,
	...
	var resource ImageUpdateAutomationList
	err := ctx.ReadResource("kubernetes:image.toolkit.fluxcd.io/v1beta2:ImageUpdateAutomationList", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
