...
func NewImageRepositoryPatch(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("kubernetes:image.toolkit.fluxcd.io/v1beta1:ImageRepositoryPatch"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource ImageRepositoryPatch
	err := ctx.RegisterResource("kubernetes:image.toolkit.fluxcd.io/v1beta2:ImageRepositoryPatch", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetImageRepositoryPatch(ctx *pulumi.Context,
	...
	var resource ImageRepositoryPatch
	err := ctx.ReadResource("kubernetes:image.toolkit.fluxcd.io/v1beta2:ImageRepositoryPatch", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
