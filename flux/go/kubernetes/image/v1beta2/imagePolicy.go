...
func NewImagePolicy(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("kubernetes:image.toolkit.fluxcd.io/v1beta1:ImagePolicy"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource ImagePolicy
	err := ctx.RegisterResource("kubernetes:image.toolkit.fluxcd.io/v1beta2:ImagePolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetImagePolicy(ctx *pulumi.Context,
	...
	var resource ImagePolicy
	err := ctx.ReadResource("kubernetes:image.toolkit.fluxcd.io/v1beta2:ImagePolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
