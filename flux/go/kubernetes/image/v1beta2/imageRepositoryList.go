...
func NewImageRepositoryList(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:image.toolkit.fluxcd.io/v1beta2:ImageRepositoryList", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetImageRepositoryList(ctx *pulumi.Context,
	...
	var resource ImageRepositoryList
	err := ctx.ReadResource("kubernetes:image.toolkit.fluxcd.io/v1beta2:ImageRepositoryList", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
