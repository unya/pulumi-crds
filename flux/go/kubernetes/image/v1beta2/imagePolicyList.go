...
func NewImagePolicyList(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:image.toolkit.fluxcd.io/v1beta2:ImagePolicyList", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetImagePolicyList(ctx *pulumi.Context,
	...
	var resource ImagePolicyList
	err := ctx.ReadResource("kubernetes:image.toolkit.fluxcd.io/v1beta2:ImagePolicyList", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
