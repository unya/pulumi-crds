...
func NewHelmRelease(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("kubernetes:helm.toolkit.fluxcd.io/v2beta1:HelmRelease"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource HelmRelease
	err := ctx.RegisterResource("kubernetes:helm.toolkit.fluxcd.io/v2beta2:HelmRelease", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetHelmRelease(ctx *pulumi.Context,
	...
	var resource HelmRelease
	err := ctx.ReadResource("kubernetes:helm.toolkit.fluxcd.io/v2beta2:HelmRelease", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
