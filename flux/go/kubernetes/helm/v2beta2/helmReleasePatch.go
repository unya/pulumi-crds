...
func NewHelmReleasePatch(ctx *pulumi.Context,
	...
	args.ApiVersion = pulumi.StringPtr("helm.toolkit.fluxcd.io/v2beta2")
	args.Kind = pulumi.StringPtr("HelmRelease")
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("kubernetes:helm.toolkit.fluxcd.io/v2:HelmReleasePatch"),
		},
		{
	...
	err := ctx.RegisterResource("kubernetes:helm.toolkit.fluxcd.io/v2beta2:HelmReleasePatch", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetHelmReleasePatch(ctx *pulumi.Context,
	...
	var resource HelmReleasePatch
	err := ctx.ReadResource("kubernetes:helm.toolkit.fluxcd.io/v2beta2:HelmReleasePatch", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
