...
func NewHelmRelease(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:helm.toolkit.fluxcd.io/v2:HelmRelease", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetHelmRelease(ctx *pulumi.Context,
	...
	var resource HelmRelease
	err := ctx.ReadResource("kubernetes:helm.toolkit.fluxcd.io/v2:HelmRelease", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
