...
func NewHelmReleasePatch(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:helm.toolkit.fluxcd.io/v2beta1:HelmReleasePatch", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetHelmReleasePatch(ctx *pulumi.Context,
	...
	var resource HelmReleasePatch
	err := ctx.ReadResource("kubernetes:helm.toolkit.fluxcd.io/v2beta1:HelmReleasePatch", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
