...
func NewAlert(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("kubernetes:notification.toolkit.fluxcd.io/v1beta1:Alert"),
		},
		{
	...
	var resource Alert
	err := ctx.RegisterResource("kubernetes:notification.toolkit.fluxcd.io/v1beta2:Alert", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAlert(ctx *pulumi.Context,
	...
	var resource Alert
	err := ctx.ReadResource("kubernetes:notification.toolkit.fluxcd.io/v1beta2:Alert", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
