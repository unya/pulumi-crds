...
func NewProviderPatch(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:notification.toolkit.fluxcd.io/v1beta2:ProviderPatch", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetProviderPatch(ctx *pulumi.Context,
	...
	var resource ProviderPatch
	err := ctx.ReadResource("kubernetes:notification.toolkit.fluxcd.io/v1beta2:ProviderPatch", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
