...
func NewProvider(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:notification.toolkit.fluxcd.io/v1beta2:Provider", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetProvider(ctx *pulumi.Context,
	...
	var resource Provider
	err := ctx.ReadResource("kubernetes:notification.toolkit.fluxcd.io/v1beta2:Provider", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
