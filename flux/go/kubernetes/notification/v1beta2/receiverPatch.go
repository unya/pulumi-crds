...
func NewReceiverPatch(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("kubernetes:notification.toolkit.fluxcd.io/v1beta1:ReceiverPatch"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource ReceiverPatch
	err := ctx.RegisterResource("kubernetes:notification.toolkit.fluxcd.io/v1beta2:ReceiverPatch", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetReceiverPatch(ctx *pulumi.Context,
	...
	var resource ReceiverPatch
	err := ctx.ReadResource("kubernetes:notification.toolkit.fluxcd.io/v1beta2:ReceiverPatch", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
