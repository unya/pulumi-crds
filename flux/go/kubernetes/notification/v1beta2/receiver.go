...
func NewReceiver(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("kubernetes:notification.toolkit.fluxcd.io/v1:Receiver"),
		},
		{
	...
	err := ctx.RegisterResource("kubernetes:notification.toolkit.fluxcd.io/v1beta2:Receiver", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetReceiver(ctx *pulumi.Context,
	...
	var resource Receiver
	err := ctx.ReadResource("kubernetes:notification.toolkit.fluxcd.io/v1beta2:Receiver", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
