...
func NewAlertPatch(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:notification.toolkit.fluxcd.io/v1beta3:AlertPatch", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAlertPatch(ctx *pulumi.Context,
	...
	var resource AlertPatch
	err := ctx.ReadResource("kubernetes:notification.toolkit.fluxcd.io/v1beta3:AlertPatch", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
