...
type ProviderPatch struct {
	...
	Status   ProviderStatusPatchPtrOutput    `pulumi:"status"`
}
...
func NewProviderPatch(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("kubernetes:notification.toolkit.fluxcd.io/v1beta3:ProviderPatch"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource ProviderPatch
	err := ctx.RegisterResource("kubernetes:notification.toolkit.fluxcd.io/v1beta1:ProviderPatch", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetProviderPatch(ctx *pulumi.Context,
	...
	var resource ProviderPatch
	err := ctx.ReadResource("kubernetes:notification.toolkit.fluxcd.io/v1beta1:ProviderPatch", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (o ProviderPatchOutput) Status() ProviderStatusPatchPtrOutput {
	return o.ApplyT(func(v *ProviderPatch) ProviderStatusPatchPtrOutput { return v.Status }).(ProviderStatusPatchPtrOutput)
}
