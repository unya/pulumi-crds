...
type Provider struct {
	...
	Status   ProviderStatusPtrOutput `pulumi:"status"`
}
...
func NewProvider(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("kubernetes:notification.toolkit.fluxcd.io/v1beta3:Provider"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource Provider
	err := ctx.RegisterResource("kubernetes:notification.toolkit.fluxcd.io/v1beta1:Provider", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetProvider(ctx *pulumi.Context,
	...
	var resource Provider
	err := ctx.ReadResource("kubernetes:notification.toolkit.fluxcd.io/v1beta1:Provider", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (o ProviderOutput) Status() ProviderStatusPtrOutput {
	return o.ApplyT(func(v *Provider) ProviderStatusPtrOutput { return v.Status }).(ProviderStatusPtrOutput)
}
