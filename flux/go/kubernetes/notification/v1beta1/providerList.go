...
func NewProviderList(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:notification.toolkit.fluxcd.io/v1beta1:ProviderList", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetProviderList(ctx *pulumi.Context,
	...
	var resource ProviderList
	err := ctx.ReadResource("kubernetes:notification.toolkit.fluxcd.io/v1beta1:ProviderList", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
