...
func NewAlertList(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:notification.toolkit.fluxcd.io/v1beta1:AlertList", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAlertList(ctx *pulumi.Context,
	...
	var resource AlertList
	err := ctx.ReadResource("kubernetes:notification.toolkit.fluxcd.io/v1beta1:AlertList", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
