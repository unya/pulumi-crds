...
func NewReceiverPatch(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:notification.toolkit.fluxcd.io/v1:ReceiverPatch", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetReceiverPatch(ctx *pulumi.Context,
	...
	var resource ReceiverPatch
	err := ctx.ReadResource("kubernetes:notification.toolkit.fluxcd.io/v1:ReceiverPatch", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
