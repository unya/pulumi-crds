...
func NewReceiverList(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:notification.toolkit.fluxcd.io/v1:ReceiverList", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetReceiverList(ctx *pulumi.Context,
	...
	var resource ReceiverList
	err := ctx.ReadResource("kubernetes:notification.toolkit.fluxcd.io/v1:ReceiverList", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
