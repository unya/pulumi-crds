...
func NewHelmChartList(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:source.toolkit.fluxcd.io/v1beta2:HelmChartList", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetHelmChartList(ctx *pulumi.Context,
	...
	var resource HelmChartList
	err := ctx.ReadResource("kubernetes:source.toolkit.fluxcd.io/v1beta2:HelmChartList", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
