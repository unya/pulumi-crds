...
func NewHelmRepository(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("kubernetes:source.toolkit.fluxcd.io/v1beta1:HelmRepository"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource HelmRepository
	err := ctx.RegisterResource("kubernetes:source.toolkit.fluxcd.io/v1beta2:HelmRepository", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetHelmRepository(ctx *pulumi.Context,
	...
	var resource HelmRepository
	err := ctx.ReadResource("kubernetes:source.toolkit.fluxcd.io/v1beta2:HelmRepository", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
