...
func NewHelmRepositoryList(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:source.toolkit.fluxcd.io/v1beta2:HelmRepositoryList", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetHelmRepositoryList(ctx *pulumi.Context,
	...
	var resource HelmRepositoryList
	err := ctx.ReadResource("kubernetes:source.toolkit.fluxcd.io/v1beta2:HelmRepositoryList", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
