...
func NewGitRepository(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("kubernetes:source.toolkit.fluxcd.io/v1:GitRepository"),
		},
		{
	...
	err := ctx.RegisterResource("kubernetes:source.toolkit.fluxcd.io/v1beta2:GitRepository", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGitRepository(ctx *pulumi.Context,
	...
	var resource GitRepository
	err := ctx.ReadResource("kubernetes:source.toolkit.fluxcd.io/v1beta2:GitRepository", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
