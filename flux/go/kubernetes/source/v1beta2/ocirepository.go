...
func NewOCIRepository(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("kubernetes:source.toolkit.fluxcd.io/v1:OCIRepository"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource OCIRepository
	err := ctx.RegisterResource("kubernetes:source.toolkit.fluxcd.io/v1beta2:OCIRepository", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOCIRepository(ctx *pulumi.Context,
	...
	var resource OCIRepository
	err := ctx.ReadResource("kubernetes:source.toolkit.fluxcd.io/v1beta2:OCIRepository", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
