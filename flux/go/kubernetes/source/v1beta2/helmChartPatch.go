...
func NewHelmChartPatch(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("kubernetes:source.toolkit.fluxcd.io/v1beta1:HelmChartPatch"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource HelmChartPatch
	err := ctx.RegisterResource("kubernetes:source.toolkit.fluxcd.io/v1beta2:HelmChartPatch", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetHelmChartPatch(ctx *pulumi.Context,
	...
	var resource HelmChartPatch
	err := ctx.ReadResource("kubernetes:source.toolkit.fluxcd.io/v1beta2:HelmChartPatch", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
