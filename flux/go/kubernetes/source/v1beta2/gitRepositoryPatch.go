...
func NewGitRepositoryPatch(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("kubernetes:source.toolkit.fluxcd.io/v1:GitRepositoryPatch"),
		},
		{
	...
	err := ctx.RegisterResource("kubernetes:source.toolkit.fluxcd.io/v1beta2:GitRepositoryPatch", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGitRepositoryPatch(ctx *pulumi.Context,
	...
	var resource GitRepositoryPatch
	err := ctx.ReadResource("kubernetes:source.toolkit.fluxcd.io/v1beta2:GitRepositoryPatch", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
