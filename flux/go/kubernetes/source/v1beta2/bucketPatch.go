...
func NewBucketPatch(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("kubernetes:source.toolkit.fluxcd.io/v1beta1:BucketPatch"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource BucketPatch
	err := ctx.RegisterResource("kubernetes:source.toolkit.fluxcd.io/v1beta2:BucketPatch", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBucketPatch(ctx *pulumi.Context,
	...
	var resource BucketPatch
	err := ctx.ReadResource("kubernetes:source.toolkit.fluxcd.io/v1beta2:BucketPatch", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
