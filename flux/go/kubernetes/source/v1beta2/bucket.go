...
func NewBucket(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("kubernetes:source.toolkit.fluxcd.io/v1beta1:Bucket"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource Bucket
	err := ctx.RegisterResource("kubernetes:source.toolkit.fluxcd.io/v1beta2:Bucket", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBucket(ctx *pulumi.Context,
	...
	var resource Bucket
	err := ctx.ReadResource("kubernetes:source.toolkit.fluxcd.io/v1beta2:Bucket", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
