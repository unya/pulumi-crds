...
func NewHelmChart(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:source.toolkit.fluxcd.io/v1:HelmChart", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetHelmChart(ctx *pulumi.Context,
	...
	var resource HelmChart
	err := ctx.ReadResource("kubernetes:source.toolkit.fluxcd.io/v1:HelmChart", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
