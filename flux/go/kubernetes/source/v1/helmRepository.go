...
func NewHelmRepository(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:source.toolkit.fluxcd.io/v1:HelmRepository", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetHelmRepository(ctx *pulumi.Context,
	...
	var resource HelmRepository
	err := ctx.ReadResource("kubernetes:source.toolkit.fluxcd.io/v1:HelmRepository", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
