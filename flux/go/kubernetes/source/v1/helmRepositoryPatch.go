...
func NewHelmRepositoryPatch(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:source.toolkit.fluxcd.io/v1:HelmRepositoryPatch", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetHelmRepositoryPatch(ctx *pulumi.Context,
	...
	var resource HelmRepositoryPatch
	err := ctx.ReadResource("kubernetes:source.toolkit.fluxcd.io/v1:HelmRepositoryPatch", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
