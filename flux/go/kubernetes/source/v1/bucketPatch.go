...
func NewBucketPatch(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:source.toolkit.fluxcd.io/v1:BucketPatch", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBucketPatch(ctx *pulumi.Context,
	...
	var resource BucketPatch
	err := ctx.ReadResource("kubernetes:source.toolkit.fluxcd.io/v1:BucketPatch", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
