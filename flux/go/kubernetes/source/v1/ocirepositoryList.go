...
func NewOCIRepositoryList(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:source.toolkit.fluxcd.io/v1:OCIRepositoryList", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOCIRepositoryList(ctx *pulumi.Context,
	...
	var resource OCIRepositoryList
	err := ctx.ReadResource("kubernetes:source.toolkit.fluxcd.io/v1:OCIRepositoryList", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
