...
func NewHelmChartPatch(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:source.toolkit.fluxcd.io/v1:HelmChartPatch", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetHelmChartPatch(ctx *pulumi.Context,
	...
	var resource HelmChartPatch
	err := ctx.ReadResource("kubernetes:source.toolkit.fluxcd.io/v1:HelmChartPatch", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
