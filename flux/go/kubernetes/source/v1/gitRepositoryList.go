...
func NewGitRepositoryList(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:source.toolkit.fluxcd.io/v1:GitRepositoryList", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGitRepositoryList(ctx *pulumi.Context,
	...
	var resource GitRepositoryList
	err := ctx.ReadResource("kubernetes:source.toolkit.fluxcd.io/v1:GitRepositoryList", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
