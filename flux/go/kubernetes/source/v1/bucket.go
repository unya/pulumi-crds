...
func NewBucket(ctx *pulumi.Context,
	...
	var resource Bucket
	err := ctx.RegisterResource("kubernetes:source.toolkit.fluxcd.io/v1:Bucket", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBucket(ctx *pulumi.Context,
	...
	var resource Bucket
	err := ctx.ReadResource("kubernetes:source.toolkit.fluxcd.io/v1:Bucket", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
