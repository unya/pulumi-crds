...
func NewGitRepositoryPatch(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:source.toolkit.fluxcd.io/v1beta1:GitRepositoryPatch", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGitRepositoryPatch(ctx *pulumi.Context,
	...
	var resource GitRepositoryPatch
	err := ctx.ReadResource("kubernetes:source.toolkit.fluxcd.io/v1beta1:GitRepositoryPatch", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
