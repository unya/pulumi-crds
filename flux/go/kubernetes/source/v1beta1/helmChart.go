...
func NewHelmChart(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("kubernetes:source.toolkit.fluxcd.io/v1beta2:HelmChart"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource HelmChart
	err := ctx.RegisterResource("kubernetes:source.toolkit.fluxcd.io/v1beta1:HelmChart", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetHelmChart(ctx *pulumi.Context,
	...
	var resource HelmChart
	err := ctx.ReadResource("kubernetes:source.toolkit.fluxcd.io/v1beta1:HelmChart", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
