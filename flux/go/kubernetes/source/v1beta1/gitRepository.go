...
func NewGitRepository(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:source.toolkit.fluxcd.io/v1beta1:GitRepository", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGitRepository(ctx *pulumi.Context,
	...
	var resource GitRepository
	err := ctx.ReadResource("kubernetes:source.toolkit.fluxcd.io/v1beta1:GitRepository", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
