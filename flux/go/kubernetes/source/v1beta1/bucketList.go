...
func NewBucketList(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:source.toolkit.fluxcd.io/v1beta1:BucketList", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBucketList(ctx *pulumi.Context,
	...
	var resource BucketList
	err := ctx.ReadResource("kubernetes:source.toolkit.fluxcd.io/v1beta1:BucketList", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
