...
func NewKustomizationPatch(ctx *pulumi.Context,
	...
	args.ApiVersion = pulumi.StringPtr("kustomize.toolkit.fluxcd.io/v1beta1")
	args.Kind = pulumi.StringPtr("Kustomization")
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("kubernetes:kustomize.toolkit.fluxcd.io/v1:KustomizationPatch"),
		},
		{
	...
	err := ctx.RegisterResource("kubernetes:kustomize.toolkit.fluxcd.io/v1beta1:KustomizationPatch", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetKustomizationPatch(ctx *pulumi.Context,
	...
	var resource KustomizationPatch
	err := ctx.ReadResource("kubernetes:kustomize.toolkit.fluxcd.io/v1beta1:KustomizationPatch", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
