...
func NewKustomization(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("kubernetes:kustomize.toolkit.fluxcd.io/v1beta2:Kustomization"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource Kustomization
	err := ctx.RegisterResource("kubernetes:kustomize.toolkit.fluxcd.io/v1beta1:Kustomization", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetKustomization(ctx *pulumi.Context,
	...
	var resource Kustomization
	err := ctx.ReadResource("kubernetes:kustomize.toolkit.fluxcd.io/v1beta1:Kustomization", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
