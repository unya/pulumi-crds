...
func NewKustomization(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:kustomize.toolkit.fluxcd.io/v1:Kustomization", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetKustomization(ctx *pulumi.Context,
	...
	var resource Kustomization
	err := ctx.ReadResource("kubernetes:kustomize.toolkit.fluxcd.io/v1:Kustomization", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
