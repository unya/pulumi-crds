...
func NewKustomizationList(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:kustomize.toolkit.fluxcd.io/v1beta2:KustomizationList", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetKustomizationList(ctx *pulumi.Context,
	...
	var resource KustomizationList
	err := ctx.ReadResource("kubernetes:kustomize.toolkit.fluxcd.io/v1beta2:KustomizationList", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
