...
func NewKustomizationPatch(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:kustomize.toolkit.fluxcd.io/v1beta2:KustomizationPatch", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetKustomizationPatch(ctx *pulumi.Context,
	...
	var resource KustomizationPatch
	err := ctx.ReadResource("kubernetes:kustomize.toolkit.fluxcd.io/v1beta2:KustomizationPatch", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
